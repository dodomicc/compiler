...
import { ERROR, CustomError } from '../Error/errors'
import { Order, OrderType, OrderUpdate, TimeInForce } from '../OrderUtils/order'
import { OrderQueue } from '../OrderUtils/orderqueue'
import { OrderSide } from '../OrderUtils/orderside'
  ...
  public createOrder = (
    ...
    switch (createOrderType.type) {
      ...
      case OrderType.LIMIT:
        return this.limit(
          createOrderType.side,
          createOrderType.orderID as string,
          createOrderType.size,
          createOrderType.price as number,
          createOrderType.timeInForce?createOrderType.timeInForce:TimeInForce.GTC
        )
      default:
        return {
          done: [],

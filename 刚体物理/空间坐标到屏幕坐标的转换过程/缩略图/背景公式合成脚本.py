...
def merge_all_images_in_folder(folder_path,start_i):
    def process_images(start_i, step,vao,fbo):
        ...
        while True:
            ...
            out_path = os.path.join('../', f"缩略图.png")
    ...
    process_images(start_i, 1,vao,fbo)
    print("✅ 所有图像合成完毕")
...
if __name__ == "__main__":
    ...
    merge_all_images_in_folder("./公式背景帧序列",start_i=0)
